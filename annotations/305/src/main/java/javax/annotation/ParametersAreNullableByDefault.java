 ...
 * </ul>
 *
 * <p>This annotation implies the same "nullness" as no annotation. However, it is different than
 * having no annotation, as it is inherited and it can override a ParametersAreNonnullByDefault
